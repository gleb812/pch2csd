...
int SearchK2AModules(void)
{
    ...
    // «агрузка правил замены Modules на seludoM из каталога "RulesK2A"
    ...
    if(dir)
    {
        ...
        while((ent = readdir(dir)) != NULL)
        {
            ...
            if(Name[0]!=0x2E) // if first symbol not "."
            {
                ...
                for(i=0;i<4;i++)
                {
                    ...
                    {
                        K2AModulesIDTable[K2AModulesIDCount]=K2AModulesIDTable[K2AModulesIDCount]*10+(unsigned int)(Name[i])-48;
                    }
                }
        ...
        */
        ...
        // —верка соединени€ модулей кабел€ми согласно правилам
        for(c=0;c<CCa;c++)
        {
            /*
