...
int ReadMP(unsigned int position) //Reading Module Parameters
{
    ...
    for (i = 0; i < ModuleCount; i++) {
        ...
        ModuleIndex = 0x80 * ModuleHead[0] + 0x40 * ModuleHead[1] + 0x20 * ModuleHead[2] + 0x10 * ModuleHead[3] +
                      0x08 * ModuleHead[4] + 0x04 * ModuleHead[5] + 0x02 * ModuleHead[6] + ModuleHead[7];
        ...
        ParameterCount = 0x80 * ModuleHead[8] + 0x40 * ModuleHead[9] + 0x20 * ModuleHead[10] + 0x10 * ModuleHead[11] +
                         0x08 * ModuleHead[12] + 0x04 * ModuleHead[13] + 0x02 * ModuleHead[14] + ModuleHead[15];
        ParameterCount = 0x40 * ModuleHead[8] + 0x20 * ModuleHead[9] + 0x10 * ModuleHead[10] + 0x08 * ModuleHead[11] +
                         0x04 * ModuleHead[12] + 0x02 * ModuleHead[13] + ModuleHead[14];
        ...
        for (k = 0; k < 9; k++) {
            ...
            Variation = 0x80 * ModuleParameter[0] + 0x40 * ModuleParameter[1] + 0x20 * ModuleParameter[2] +
                        0x10 * ModuleParameter[3] + 0x08 * ModuleParameter[4] + 0x04 * ModuleParameter[5] +
                        0x02 * ModuleParameter[6] + ModuleParameter[7];
            //printf("MP_Variation = ");
            //printf("%d\n",Variation);
            ...
            for (g = 0; g < ParameterCount; g++) {
                ...
                Value = 0x40 * ModuleParameter[0] + 0x20 * ModuleParameter[1] + 0x10 * ModuleParameter[2] +
                        0x08 * ModuleParameter[3] + 0x04 * ModuleParameter[4] + 0x02 * ModuleParameter[5] +
                        ModuleParameter[6];
                //printf("MP_Value = ");
                //printf("%d\n",Value);
