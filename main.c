...
char NewFileName[20]="new.csd"; // Output csd file
char PatchFileName[20]="GlobalTest.pch2"; // Clavia NM2 patch file
char HeadFileName[20]="Heads/Header.txt"; // Csound header template
char EndingFileName[20]="Heads/Ending.txt"; // Csound tail template (score and XML ending)
